...
HD_PWD='C:/Users/RazBB/Desktop/RP_FPGA/RP_out_mix/RP_out_mix.runs/Sine_wave_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sine_wave.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Sine_wave.tcl
