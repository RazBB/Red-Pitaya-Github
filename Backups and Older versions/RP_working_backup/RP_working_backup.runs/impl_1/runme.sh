...
HD_PWD='C:/Users/RazBB/Desktop/RP_FPGA/RP_out_mix/RP_out_mix.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log red_pitaya_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source red_pitaya_top.tcl -notrace
