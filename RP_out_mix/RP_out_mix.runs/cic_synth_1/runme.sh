...
HD_PWD='C:/Users/RazBB/Desktop/RP_FPGA/RP_out_mix/RP_out_mix.runs/cic_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cic.vds -m64 -mode batch -messageDb vivado.pb -notrace -source cic.tcl
