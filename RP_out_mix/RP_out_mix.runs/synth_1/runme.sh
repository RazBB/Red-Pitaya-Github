...
HD_PWD='C:/Users/RazBB/Desktop/RP_FPGA/RP_out_mix/RP_out_mix.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log red_pitaya_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source red_pitaya_top.tcl
